...
\brief Declaration of DiffusionTensor3DReconstructionImageFilter
 ...
 * sbia additions to itk DiffusionTensor3DRecon Filter
   added a spatial Object as a mask.
   added cludge to fix nonSPD tensors. at the moment only this just
   takes abs of any negative eigenvalues. Posible future direction is to
   include spd constrain when this occurs.
...
public:
  ...
  typedef typename TensorPixelType::EigenValuesArrayType
                                                    TensorEigenValuesType;

  typedef typename TensorPixelType::EigenVectorsMatrixType
                                                    TensorEigenVectorsType;

  typedef typename TensorPixelType::MatrixType
                                                    TensorMatrixType;
...
//  typedef VectorImage< typename NumericTraits<GradientPixelType>::RealType, 3 >
  typedef VectorImage< GradientPixelType, 3 >
                                                   ResidualImageType;
...
protected:
  ...
  /* method to compute the residual */
...
private:
  ...
  /* Tensor basis coefficients */
  TensorBasisInverseMatrixType                      m_TensorBasisInverse;
...
#include "itkDiffusionTensor3DReconstructionImageFilter.cpp"
#endif
